...
class ModuleBase(object):
    ...
    def _get_info_profiles(self, module_specs):
        ...
        for module_spec in module_specs:
            ...
            for module in module_list:
                ...
                for profile in sorted(module.getProfiles(), key=_profile_sorter):
    ...
    def _profile_report_formatter(self, modulePackage, default_profiles, enabled_str):
        ...
        profiles_str = ""
        for profile in sorted(available_profiles, key=_profile_sorter):
            profiles_str += "{}{}".format(
        ...
        for modulePackage in modulePackages:
            ...
            if query:
                for pkg in query:
                    string_output = ""
                    profiles = []
                    for profile in sorted(modulePackage.getProfiles(), key=_profile_sorter):
